 ...
 */
#define INPUT_SHAPING_X //IP
#define INPUT_SHAPING_Y //IP
  ...
  #define SHAPING_MENU       //IP         // Add a menu to the LCD to set shaping parameters.
#endif
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.22 //IP default 0.0         // (mm) Compression length applying to all extruders
  #endif
