 ...
 */
//#define PIDTEMP    //IP default on       // See the PID Tuning Guide at https://reprap.org/wiki/PID_Tuning
#define MPCTEMP     //IP default off       // ** EXPERIMENTAL ** See https://marlinfw.org/docs/features/model_predictive_control.html
 ...
 */
  ...
  #define MPC_HEATER_POWER { 40.0f } //IP double check this default                 // (W) Heat cartridge powers.
